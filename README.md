...
обрати кадр із бібліотеки — надійно на KDE, best-effort на GNOME/Windows),
**англійська/українська** мова (авто за локаллю) та інсталятор, що розпаковує
зображення в системну теку, пише дефолтний конфіг, ставить кастомну іконку й
додає в автозапуск.
```fish
