...
авторство якого належить **mb0sco** та **steezyasfuck** — їм подяка за вихідний
арт, що задав композицію, стиль і атмосферу всього набору. Згенеровані кадри —
похідні від цієї роботи.
