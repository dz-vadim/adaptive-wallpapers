...
блокування** (не чіпати / дзеркалити робочий стіл / обрати кадр із бібліотеки —
надійно на KDE, best-effort на GNOME/Windows) та інсталятор, що розпаковує
зображення в системну теку, пише дефолтний конфіг і додає в автозапуск.
```fish
